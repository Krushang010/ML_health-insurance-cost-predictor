...
model_rest = load('artifacts/model_Rest_joblib')
model_young = load('artifacts/model_young_joblib')

scaler_rest = load('artifacts/scaler_Rest_joblib')
scaler_young = load('artifacts/scaler_young_joblib')
...
def handle_scaling(age, df):
    ...
    scale_col = scaler_object['cols_to_scale']
